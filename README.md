...
It is highly recommended to use [kcpraw releases](https://github.com/zhengying/kcpraw/releases).  
...
```  
$ go get -u -v github.com/zhengying/kcpraw/client
$ go get -u -v github.com/zhengying/kcpraw/server  

# or 
$ go get github.com/zhengying/kcpraw  
$ cd $GOPATH/src/github.com/zhengying/kcpraw  
$ ./build.sh  
```  
...
https://github.com/zhengying/kcpraw/issues  
